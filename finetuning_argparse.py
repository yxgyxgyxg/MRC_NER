...
def get_argparse():
    ...
    parser.add_argument("--data_dir", type=str, default="data/ccfner_mrc_format", help="data dir")
    parser.add_argument("--bert_config_dir", type=str, default="prev_trained_model/bert-base", help="bert config dir")
    ...
    parser.add_argument("--max_epochs", default=20, type=float,
                        help="Emax_epochs")
